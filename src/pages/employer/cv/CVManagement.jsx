...
import { fetchResume, fetchResumeByCompany } from "../../../redux/slice/ResumeSlide";
...
const CVManagement = () => {
  ...
  const isFetchingJob = useAppSelector((state) => state.job.isFetching);
  ...
  useEffect(() => {
    ...
    dispatch(fetchResumeByCompany({id: id,  query: initialQuery }));
  }, [dispatch]);
